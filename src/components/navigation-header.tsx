...
import { BlogSiteProps } from '@/theme/types'
...
const NavigationHeader: React.FC<{ siteProps: BlogSiteProps }> = ({
  siteProps
}) => {
  ...
  const { rootPath, basePath } = siteProps.blog
...
const LogoLink = styled(Link)<{ back: string; title?: string }>`
  position: relative;
  display: flex;
  align-items: center;
